                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <td><?php echo $data['tiketmasuk']; ?> </td>
                                                ...
                                                <td><a href="updatewisata.php?no=<?php echo $data['no']; ?>">edit</td>
                                                <td> <a href="hapuswisata.php?no=<?php echo $data['no']; ?>" onclick="return confirm ('Anda Yakin Menghapus?')"> Hapus </td>
                                         <?php       
                                        }
                                        ?>
                                        </tbody>
