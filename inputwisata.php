...
@$query = "INSERT INTO tb_kuliner VALUES ('','$namatempat','$alamat','$tiketmasuk',$fasilitas,'$jambukatutup','$deskripsi','$map','$gambar')";
...
if (isset($_POST['submit'])) {
  ...
  if ($hasil) {
    ...
    echo "<script>alert('Gagal Dibuat');
                document.location='inputwisata.php'</script>";
  }
}
?>
<?php 
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <form method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="tiketmasuk">tiketmasuk</label>
                                            <input type="text" class="form-control" name="tiketmasuk" placeholder="Masukkan tiketmasuk">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control" name="fasilitas" placeholder="Masukkan Deskripsi" rows="3"></textarea> 
                                        </div>
                                        <div class="form-group">
