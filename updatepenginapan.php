...
<body>
    <?php
        ...
        include "koneksi.php";
        $no = $_GET['no'];
        $query = "SELECT * FROM tb_tempatbaru WHERE no='$no'";
                        ...
                        <div class="col-xs-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <form method="post" action="prosesupdatepenginapan.php" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="harga" placeholder="Masukkan Tiket Masuk" value="<?php echo $data['harga']; ?>">
                                        </div>
                                        <div class="form-group">
