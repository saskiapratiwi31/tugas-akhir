                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover" id="">
                                        ...
                                        <tbody>
                                            <?php
                                            include 'koneksi.php';
                                            $query = "SELECT * FROM tb_tempatbaru";
                                            ...
                                            ?>
                                                ...
                                                <td><a href="updatepenginapan.php?no=<?php echo $data['no']; ?>">edit</td>
                                                <td> <a href="hapuspenginapan.php?no=<?php echo $data['no']; ?>" onclick="return confirm ('Anda Yakin Menghapus?')"> Hapus </td>
                                         <?php       
                                        }
                                        ?>
                                        </tbody>
