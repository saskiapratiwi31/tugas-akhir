                                        ...
                                        <tbody>
                                            <?php 
                                                 include "koneksi.php"; //panggil file koneksi
                                                  $query="SELECT * FROM login";//buat query sql
                                             ...
                                             <tr>
                                                ...
                                                <td><a href="delete.php?username=<?php echo $data ['username']; ?>"onclick="return confirm('apakah anda yakin?')" class="btn btn-primary">Delete</a></td>
                                              </tr>
                                              <?php
                                            }
                                             ?>
