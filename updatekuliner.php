...
<body>
    <?php
        ...
        include "koneksi.php";
        $no = $_GET['no'];
        $query = "SELECT * FROM tb_kuliner WHERE no='$no'";
                        ...
                        <div class="col-xs-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <form method="post" action="prosesupdatekuliner.php" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="menu">Buka-Tutup</label>
                                            <textarea type="text" class="form-control" name="menu" placeholder="Masukkan menu " rows="3"><?php echo $data['menu']; ?></textarea> 
                                        </div>
                                        <div class="form-group">
