...
$query = "UPDATE tb_kuliner SET no='$no',namatempat='$namatempat',alamat='$alamat',menu='$menu',jambukatutup='$jambukatutup',deskripsi='$deskripsi',map='$map',gambar='$gambar' WHERE no='$no'";
