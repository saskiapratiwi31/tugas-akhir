...
<html lang="en">
  ...
  <body >
    ...
    <div class="jumbotron penginapan">
  <h1 class="display-4 slogan" id="slogan"> CARI TEMPAT PENGINAPAN DISINI!</h1>
</div>
    <div class="container">
    ...
    <div class="row justify-content-center row-item">
        ...
        <?php
            ...
            $query="SELECT * FROM tb_tempatbaru"; //buat query sql
        ...
        <div class="row">
          ...
          foreach($hasil as $value) : $i++;?> 
            ...
            <?php 
              $id_post = $value['no'];
              $query1="SELECT * FROM tb_komentar WHERE id_postingan = '$id_post' AND kategori='penginapan'"; //buat query sql
                  ...
                  <div class="container-fluid">
                    <div class="row">
                      <div class="col-md-6">
                       ...
                       <div class="row">
                         <div class="col">
                           <form action="commentproses2.php" method="POST">
                      ...
                      <div class="col-md">
                        <ul class="list-group">
                          ...
                          <li class="list-group-item">Fasilitas : <?php echo $value['fasilitas'];?></li> 
                          <li class="list-group-item">Deskripsi : <?php echo $value['deskripsi'];?></li>
                          <li class="list-group-item">Maps : <?php echo $value['map'];?></li>
