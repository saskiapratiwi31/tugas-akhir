...
@$query = "INSERT INTO tb_tempatbaru VALUES ('','$namatempat','$alamat','$harga','$fasilitas','$deskripsi','$map','$gambar')";
...
if (isset($_POST['submit'])) {
  ...
  if ($hasil) {
    echo "<script>alert('Berhasil Dibuat');
              document.location='datapenginapan.php'
              </script>";
  } else {
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
          <div class="header"> 
                        ...
                        <ol class="breadcrumb">
                      <li><a href="#">Home</a></li>
                      <li class="active">Input Data Penginapan</li>
                    </ol> 
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="card-title">
                                        <div class="title">Input Data Penginapan</div>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <form method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="harga" placeholder="Masukkan Tiket Masuk">
                                        </div>
                                        <div class="form-group">
                                            <label for="fasilitas">Fasilitas</label>
                                            <textarea type="text" class="form-control" name="fasilitas" placeholder="Masukkan Fasilitas Tempat" rows="3"></textarea> 
                                        </div>
                                        <div class="form-group">
