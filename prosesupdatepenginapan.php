...
$query = "UPDATE tb_tempatbaru SET no='$no',namatempat='$namatempat',alamat='$alamat',harga='$harga',fasilitas='$fasilitas',deskripsi='$deskripsi',map='$map',gambar='$gambar' WHERE no='$no'";
